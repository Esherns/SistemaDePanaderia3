...
{
    public partial class Dobladita : System.Web.UI.Page
    {
        List<PedidoLocal> PedidosLocales = new List<PedidoLocal>();
        Producto PD = new Producto();
        protected void Page_Load(object sender, EventArgs e)
        {
            lblPrecio.Text = PD.ObtenerPrecio(3).ToString();
        ...
        protected void btnAgregar_Click(object sender, EventArgs e)
        {
            ...
            PedLoc.Precio = int.Parse(txtCantidad.Text) * PD.ObtenerPrecio(3);
