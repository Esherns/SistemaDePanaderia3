...
{
    public partial class SelvaNegra : System.Web.UI.Page
    {
        List<PedidoLocal> PedidosLocales = new List<PedidoLocal>();
        Producto PD = new Producto();
        protected void Page_Load(object sender, EventArgs e)
        {
            lblPrecio.Text = PD.ObtenerPrecio(6).ToString();
        ...
        protected void btnAgregar_Click(object sender, EventArgs e)
        {
            ...
            PedLoc.Precio = int.Parse(txtCantidad.Text) * PD.ObtenerPrecio(6);
